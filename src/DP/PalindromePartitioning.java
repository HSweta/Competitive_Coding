...
public class PalindromePartitioning {
	...
	public static void main(String[] args) {
		...
		System.out.println(PalindromePartitionBU(s));

	}

	public static int PalindromePartitionRec(String s, int si, int ei) {
		...
		for (int k = si; k <= ei - 1; k++) {
			...
			int fp = PalindromePartitionRec(s, si, k);
			int sp = PalindromePartitionRec(s, k + 1, ei);
	...
	public static int PalindromePartitionTD(String s, int si, int ei, int[][] strg) {
		...
		for (int k = si; k <= ei - 1; k++) {
			...
			int fp = PalindromePartitionTD(s, si, k, strg);
			int sp = PalindromePartitionTD(s, k + 1, ei, strg);
	...
	public static int PalindromePartitionBU(String s) {
	...
	public static boolean[][] palindromeInfo(String s) {
		...
		for (int i = 0; i < isStringPalindrome.length; i++) {
			Arrays.fill(isStringPalindrome, true);
		}
