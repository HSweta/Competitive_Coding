...
public class GenericTree {
	...
	private Node construct(Node parent, int ith) {
		...
		if (parent == null) {
			...
			System.out.print("Enter the data for " + ith + " child of " + parent.data + " ?");
		}
		...
		// prompt
		System.out.println("Enter the number of childern for " + nn.data + " ?");
	...
	private boolean find1(Node node, int item) {
	...
	private void mirror1(Node node) {
	...
	public void printAtLevel(Node node, int level, int count) {
	...
	public void levelOrderLinewise() {
		...
		while (!pq.isEmpty()) {
			...
			// print the data of removes node
			System.out.print(rn.data + " ");

			// removed node chlidren enqueue
			for (Node child : rn.children) {
				hq.add(child);

			}

			// check of primary queue id empty -> level finish
			if (pq.isEmpty()) {
				System.out.println();
	...
	public void levelOrderZigZag() {
		...
		while (!ps.isEmpty()) {
			...
			// check of primary stack id empty -> level finish
			if (ps.isEmpty()) {
				System.out.println();
